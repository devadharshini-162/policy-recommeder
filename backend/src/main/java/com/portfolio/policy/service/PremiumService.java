...
@Service public class PremiumService {
 ...
 public PremiumResponse calculate(QuoteRequest r) {
  ...
  return new PremiumResponse(base,finalPremium,new PremiumResponse.Breakdown(ageFactor,smokerFactor,bmiFactor,loading),tier.recommendedTier(),tier.confidence());
 }
